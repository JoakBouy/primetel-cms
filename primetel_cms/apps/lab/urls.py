...
urlpatterns = [
    ...
    path("reports/", views.lab_reports, name="reports"),
    ...
    path("orders/<uuid:pk>/cancel/", views.lab_cancel, name="cancel"),
    path("orders/<uuid:pk>/amend/", views.lab_amend_result, name="amend"),
